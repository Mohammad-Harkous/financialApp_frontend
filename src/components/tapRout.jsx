...
// import { Route, Link,Routes,createBrowserRouter ,createRoutesFromElements, RouterProvider, Outlet} from 'react-router-dom';
...
//             <Route path="/recurrence" element={<RecTransaction/>}/>
//             <Route   path="/transaction/income" element={<Income/>}/>
//             <Route  path="/transaction/expence"  element={<Expence/>}/>
//             </Route>
//         )
//     )
//   return (
...
//         <>
//         <div>
//         <Link to="/recurrence">Recurrence</Link>
//         <Link to="/transaction/income">Income Transaction</Link>
//         <Link to="/transaction/expense">Expence Transaction </Link>
//         </div>
//             <div>
//                 <Outlet/>
//             </div>
