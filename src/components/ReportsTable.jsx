...
export default function Reptable(props) {
  ...
  const apiURL = `http://127.0.0.1:8000/api/transaction/${year}`;
  ...
  return (
    ...
    >
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
            <TextField
              ...
              onChange={(e) =>
                setNewData({ ...newData, type_of_transaction: e.target.value })
              }
              fullWidth
              margin="dense"
            >
          ...
          <Grid item xs={6}>
            <TextField
              ...
              value={newData.D_O_T}
              onChange={(e) =>
                setNewData({ ...newData, D_O_T: e.target.value })
              }
            />
          </Grid>
          <Grid item xs={6}>
            <TextField
              ...
              onChange={(e) =>
                setNewData({ ...newData, user_id: e.target.value })
              }
            />
          </Grid>
          <Grid item xs={6}>
      ...
      {/* </Box> */}
      <Stack direction="column" width="88.3%" height="40%" ml={14}>
        <DataGrid
          rows={alldata}
          columns={columns}
          autoHeight={400}
