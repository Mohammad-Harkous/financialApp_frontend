...
import { Box, TextField, Button ,Select,MenuItem,InputAdornment,InputLabel, LinearProgress, CircularProgress,} from "@mui/material";
...
export default function DataTable() {
  ...
  const deleteUser = async (id) => {
    ...
    axios.delete(`http://localhost:8000/api/recurrence/${id}`, {});
